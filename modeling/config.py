...
def add_stn_config(cfg):
    ...
    # ZZL
    cfg.SOLVER.DOMAIN_AUG_LR_TIMES = 5000
    cfg.SOLVER.DOMAIN_AUG_L1_LR_TIMES = 5000
    cfg.SOLVER.DOMAIN_AUG_L3_LR_TIMES = 1
    cfg.SOLVER.DOMAIN_AUG_L0_LR_TIMES = 1
    cfg.SOLVER.DOMAIN_AUG_GRADMAX = 0.01
    cfg.DOMAIN_AUG_NUM = 3
    cfg.DOMAIN_AUG_FILE = "domain_prompt_pairs.txt"
